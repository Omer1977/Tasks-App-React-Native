...
const TaskDetail = ({route}) => {
  ...
  const deleteTask = async () => {
    try {
      ...
      console.log('Görev silinirken', '', error, '', 'hatası oluştu');
    }
  };
  ...
  const updateTask = async newStatus => {
    try {
      ...
      console.log('Görev güncellenirken', '', error, '', 'hatası oluştu');
    }
  };
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View
          ...
          <Text style={{fontSize: 15, fontWeight: '500'}}>Start Date:</Text>
        ...
        <View
          ...
          <Text style={{fontSize: 15, fontWeight: '500'}}>End Date:</Text>
      ...
      <View style={styles.buttons}>
        ...
        <Button onPress={deleteTask} style={styles.button} status="danger">
          DELETE
        </Button>
      </View>
    </View>
...
const styles = StyleSheet.create({
  ...
  button: {marginVertical: 7, width: 300},
  buttons: {marginBottom: 80, alignItems: 'center'},
});
